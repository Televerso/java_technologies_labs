...
public class PersonsAddress
{
     ...
     *              <li> 3 - улица</li>
     *              <li> 4 - номер дома</li>
     *              <li> 4 - номер подъезда</li>
     *              <li> 6 - номер квартиры</li>
     *              </ul>
     * <hr>
     * @return список объектов типа Person с соответствующим адресом.
     */
        ...
        for(Person person : persons)
        {
            ...
            switch(level){
                case 0:
                    ...
                    break;
                case 1:
                    if(person.getPersonAddress().getRegion().equals(attribute))
                        matching_attribute_list.add(person);
                    break;
                case 2:
                ...
                case 4:
                    ...
                    break;
                case 5:
                    if(person.getPersonAddress().getEntryway().equals(attribute))
                        matching_attribute_list.add(person);
                    break;
                case 6:
